...
@section('main')
<div id="modalReserva" class="hidden absolute w-full h-screen bg-black/70 z-50">
...
<div id="contenedorImagenIndex" style="background-image: url({{ asset('img_estaticas/index.png') }}); backgroud-position: center; background-size: cover; background-repeat: no-repeat; background-origin: border-box; flex flex-col justifybetween" class="w-full h-screen">
...
<div id="familia" class="h-screen text-white py-5 md:px-7 ps-5 flex flex-col md:flex-row">
    <div id="textoFamilia" class="md:pe-10 flex justify-center flex-col">
        <h2 class="md:text-4xl text-3xl font-bold md:pb-10 pb-5">Nuestra Familia</h2>
        ...
        <br>
        <a href="/sobre" class="bg-white font-bold text-lg text-black px-5 py-2 rounded-full text-center mb-5 md:w-1/3">Conócenos más a fondo</a>
    </div>
